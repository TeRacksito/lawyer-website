          ...
          >
            ...
            <motion.div variants={itemVariants} className="mb-12">
              ...
              <p className="text-lg lg:text-xl text-base-content/70 max-w-3xl mx-auto leading-relaxed">
                ...
                Esto puede deberse a que el contenido está en modo borrador, 
                ha sido movido o la URL no es correcta.
              </p>
            </motion.div>
          </motion.div>
        </div>
              ...
              <motion.div variants={itemVariants} className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4 p-4 bg-base-100 rounded-lg shadow-sm">
                    ...
                    <div>
                      <h4 className="font-medium text-base-content mb-1">Contenido en Borrador</h4>
                      <p className="text-sm text-base-content/70">
                        La página puede estar en modo borrador y no ser pública aún
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4 p-4 bg-base-100 rounded-lg shadow-sm">
                    ...
                    <div>
                      <h4 className="font-medium text-base-content mb-1">URL Incorrecta</h4>
                      <p className="text-sm text-base-content/70">
                  ...
                  <div className="flex items-start gap-4 p-4 bg-base-100 rounded-lg shadow-sm">
                    ...
                    <div>
                      <h4 className="font-medium text-base-content mb-1">Contenido Movido</h4>
                      <p className="text-sm text-base-content/70">
              ...
              <motion.div variants={itemVariants} className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div>
                      <h4 className="font-medium text-base-content mb-1">Verificar la URL</h4>
                      <p className="text-sm text-base-content/70">
                  ...
                  >
                    <div className="w-2 h-2 bg-success rounded-full mt-3 flex-shrink-0"></div>
                    <div>
                      <h4 className="font-medium text-base-content mb-1">Regresar al Inicio</h4>
                      <p className="text-sm text-base-content/70">
                  ...
                  >
                    <div className="w-2 h-2 bg-success rounded-full mt-3 flex-shrink-0"></div>
                    <div>
                      <h4 className="font-medium text-base-content mb-1">Contactar</h4>
                      <p className="text-sm text-base-content/70">
            ...
            <div className="bg-warning/10 border border-warning/20 rounded-lg p-8">
              <div className="text-center">
                ...
                <p className="text-base-content/70 leading-relaxed">
                  Si llegó aquí desde un enlace interno, es posible que el contenido esté 
                  siendo actualizado o se encuentre en modo borrador para revisión. 
                  Nuestro equipo trabaja constantemente para mejorar y actualizar 
      ...
      <section className="py-16">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            >
              "El derecho es la aplicación de la justicia a las circunstancias de los hombres."
            </motion.blockquote>
            <motion.p
