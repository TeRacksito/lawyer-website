...
export default function LuisCruzPage(props: ILuisCruzPageProps) {
  const milestones = [
    ...
    },
    {
      ...
      description:
        "Fundación de su propio bufete enfocado en atención personalizada",
    },
    {
      year: "2024",
  ...
  const values = [
    {
      ...
      description:
        "Cada caso es una historia personal que merece ser escuchada con respeto y dedicación.",
    },
    {
      icon: "🤝",
      title: "Cercanía",
      description:
        "Trato directo y personal. No somos un gran bufete, somos tu abogado de confianza.",
    },
    {
      icon: "🎯",
      title: "Compromiso",
      description:
        "Dedicación absoluta a cada caso, sin importar su complejidad o duración.",
    },
    {
      icon: "💡",
      title: "Innovación",
      description:
        "Combinamos la tradición jurídica con tecnologías modernas para mejores resultados.",
    },
  ];
          ...
          >
            <div>
              <h2 className="text-3xl font-semibold mb-6">
                Una vocación que nació de la necesidad
              </h2>
              <p className="text-lg mb-6">
                Mi camino en el derecho comenzó cuando era adolescente. Vi a mi
                familia luchar contra una injusticia que parecía imposible de
                resolver. El abogado que nos representó no solo ganó el caso,
                sino que nos devolvió la esperanza.
              </p>
              <p className="text-lg mb-6">
                Ese día decidí que quería ser esa persona para otros. No solo un
                técnico del derecho, sino alguien que entiende que detrás de
                cada expediente hay una vida, una familia, una historia que
                merece ser defendida.
              </p>
              <p className="text-lg">
                Hoy, después de 15 años en los tribunales, sigo con la misma
                pasión del primer día:
                <strong className="text-primary">
                  {" "}
                  defender a las personas, no solo casos.
                </strong>
              </p>
            </div>
            <motion.div
              ...
              >
                ...
                >
                  <div className="bg-base-100 p-6 rounded-lg shadow-lg">
                    <div className="hidden md:block text-primary font-bold text-xl mb-2">
                      {milestone.year}
                    </div>
      ...
      <section className="px-6 py-24">
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <p className="text-lg mb-6">
              En un mundo de grandes bufetes y procesos impersonales, yo ofrezco
              algo diferente:
              <strong className="text-primary">
                {" "}
                atención personal, comunicación directa y compromiso real
              </strong>{" "}
              con tu caso.
            </p>
            <p className="text-lg">
              No soy solo tu abogado durante el procedimiento. Soy tu consejero,
              tu defensor y, cuando todo termine, alguien en quien puedes
              confiar para el futuro.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <div className="p-6">
              ...
              <p>
                Actualización constante en las últimas tendencias legales y
                tecnológicas
              </p>
            </div>
            <div className="p-6">
              ...
              <p>
                Padre de dos hijos, entiendo la importancia de proteger lo que
                más amamos
              </p>
            </div>
            <div className="p-6">
              ...
              <p>
                Deportista aficionado que cree en la importancia del equilibrio
                vida-trabajo
              </p>
            </div>
          </motion.div>
          ...
          >
            "El derecho no es solo conocer las leyes, sino entender a las
            personas y luchar por la justicia que cada historia merece."
          </motion.blockquote>
      ...
      <section className="px-6 py-24">
        ...
        >
          ...
          <p className="text-lg mb-8">
            No importa cuán complejo sea tu caso. Si necesitas a alguien que
            luche por ti con la misma pasión que pondría en defender a su propia
            familia, estamos aquí para ayudarte.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/old/contact" className="btn btn-primary btn-lg">
              Solicitar Consulta Gratuita
            </Link>
            <Link href="/old/services" className="btn btn-outline btn-lg">
