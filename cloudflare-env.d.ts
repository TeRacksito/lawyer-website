/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 679495a085e439e1c5799668e20ac105)
// Runtime types generated with workerd@1.20251008.0 2025-03-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker-wrapper");
	}
	interface Env {
		ADMIN_NOTIFICATIONS: KVNamespace;
		NEXTJS_ENV: string;
		NEXT_PUBLIC_TINA_CLIENT_ID: string;
		TINA_TOKEN: string;
		TINA_SEARCH_TOKEN: string;
		...
		EMAIL_SENDER: string;
		EMAIL_ADMIN: string;
		NOTIFICATION_GROUP_EMAIL: string;
		ASSETS: Fetcher;
	}
}
